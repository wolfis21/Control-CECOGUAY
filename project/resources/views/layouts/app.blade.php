...
{{--                     <li>
                ...
                <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                       {{--  <a href="{{ route('register') }}"> --}}
                            <i class="bi bi-circle"></i><span>Gestion de Usuario</span>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-cart-fill"></i><span>Productos</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            <li class="nav-heading">Tienda</li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/') }}">
                    ...
                    <span>Ir a tienda</span> {{-- en este caso seria cerrar session e ir a home --}}
                </a>
